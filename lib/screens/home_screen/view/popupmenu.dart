...
import 'package:tic_tac_toe/screens/Profile/view.dart';
import 'package:tic_tac_toe/screens/home_screen/view/popupitem.dart';
...
showPopupMenu(BuildContext context) {
    showMenu<int>(
      ...
      if (itemSelected == 0) {
       ...
       //
       Navigator.of(context).push(MaterialPageRoute(builder: (_)=>TeamStandings()));
