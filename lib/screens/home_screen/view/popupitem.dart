      ...
      children: <Widget>[
        ...
        BlocBuilder<ThemeBloc,ThemeState>(
          builder: (context,state) {
            return Text(
              title,
              style: state is LightTheme ?  Theme.of(context).textTheme.headline6!.copyWith(
                  color: isActive ? Color(0xff000000) : Color(0xff000000)) : Theme.of(context).textTheme.headline6!.copyWith(
